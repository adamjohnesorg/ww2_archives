...
const TimelineSectionRight = ({ title, timelineText, year, isYearNeeded, chronNum, date, roundBottom }) => 
{
  return (
            ...
            <div className='flex flex-col w-1/12 items-center'>
                { isYearNeeded ? 
                    ...
                    <div className='timeline-h w-3/12 sm:w-full bg-gray-300 border-2 border-black shadow-sm
                                    border-b-transparent border-t-transparent shadow-white'>
                    </div>
                }
...
export default TimelineSectionRight